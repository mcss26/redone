...
## 2026-06-14
### Simplificación Tipográfica en Formularios Operativos
- **Modules:** `StaffPlanModule.jsx`, `StockRequestsModule.jsx`, `WorkDaysModule.jsx`
- **Action:** Se simplificaron las etiquetas de texto y placeholders en los paneles laterales (Slide-Overs). Por ejemplo: "Cantidad Solicitada" pasó a ser "Solicitado", "Aprobación (Admin)" a "Aprobación", "Fecha Operativa" a "Fecha".
- **Reason:** Para reducir la carga cognitiva y el ruido visual, reforzando la extrema concisión tipográfica exigida por el Functional Brutalism.
