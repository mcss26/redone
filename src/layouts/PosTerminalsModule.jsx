      ...
      <div className="flex-1 overflow-y-auto p-6 md:p-8">
        ...
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h2 className="text-xs font-extrabold tracking-[0.3em] uppercase text-brand-muted">TERMINALES POS</h2>
              <p className="text-[10px] text-brand-muted/40 tracking-wide mt-0.5">{terminals.length} terminales registradas</p>
            </div>
          </div>
