...
import { Calendar, DollarSign, Activity, FileText, AlertTriangle } from 'lucide-react';
              ...
              <div className="flex flex-col gap-4">
                <div className={`border p-6 flex flex-col justify-between h-[116px] ${
                  ...
                  <div className="flex justify-between items-start">
                    ...
                    <div className={`text-xs font-bold px-2 py-1 bg-brand-surface font-mono tracking-widest ${monthData.margin >= 0 ? 'text-brand-success' : 'text-brand-error'}`}>
